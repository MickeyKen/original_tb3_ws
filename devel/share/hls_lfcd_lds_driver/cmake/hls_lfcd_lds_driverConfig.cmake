...
if("TRUE" STREQUAL "TRUE")
  set(hls_lfcd_lds_driver_SOURCE_PREFIX /home/turltebot3-raspi/catkin_ws/src/hls_lfcd_lds_driver)
  set(hls_lfcd_lds_driver_DEVEL_PREFIX /home/turltebot3-raspi/catkin_ws/devel)
  ...
  set(hls_lfcd_lds_driver_INSTALL_PREFIX /home/turltebot3-raspi/catkin_ws/install)
...
if(NOT "/home/turltebot3-raspi/catkin_ws/src/hls_lfcd_lds_driver/include;/usr/include " STREQUAL " ")
  set(hls_lfcd_lds_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/turltebot3-raspi/catkin_ws/src/hls_lfcd_lds_driver/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turltebot3-raspi/catkin_ws/src/hls_lfcd_lds_driver/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND hls_lfcd_lds_driver_EXPORTED_TARGETS ${${hls_lfcd_lds_driver_dep}_EXPORTED_TARGETS})
endforeach()
